...
public class Zomatobase{
	...
	public void configuration() throws InterruptedException, MalformedURLException {
		...
		htmlreport = new ExtentSparkReporter("C:\\Users\\optimum\\git\\Zomato\\com.zomato.org\\ExtendReport\\FoodOrder"+".html");
		reports.attachReporter(htmlreport);
		htmlreport.config().setReportName("Zomato_Food_Order");
		htmlreport.config().setDocumentTitle("Zomato Report");
	...
	public void server_manager() throws MalformedURLException {
		...
		caps.setAppPackage("com.application.zomato");
		caps.setAppActivity("com.application.zomato.activities.Splash");
